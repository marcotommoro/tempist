...
export default function VerifyRequestPage() {
  return (
    <div className="rounded-lg border border-border bg-card/80 p-8 text-center shadow-sm backdrop-blur-sm">
      ...
      <p className="mb-2 font-mono text-[0.625em] uppercase tracking-[0.18em] text-muted-foreground">
        Magic link sent
      </p>
      ...
      <p className="font-mono text-[0.625em] uppercase tracking-[0.14em] text-muted-foreground/70">
