        ...
        <div className="mt-2 border-t border-border px-1 pt-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="ml-auto inline-flex h-8 items-center rounded bg-foreground px-3 font-mono text-[0.625em] uppercase tracking-wider text-background transition-opacity hover:opacity-90"
            >
              OK
            </button>
          </div>
        ...
        {allowClear && value && (
          <div className="mt-2 border-t border-border pt-2">
            <button
              ...
              className="inline-flex w-full items-center justify-center gap-1.5 rounded px-2 py-1.5 text-[0.75em] text-destructive transition-colors hover:bg-destructive/10"
            >
  ...
  return (
    <span className="relative inline-flex">
      <select
        ...
        className="appearance-none rounded-md border border-input bg-background py-1.5 pl-3 pr-7 text-center font-mono text-[0.875em] tabular-nums transition-colors hover:border-foreground/20 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-1"
        {...props}
      >
        {options.map((n) => (
