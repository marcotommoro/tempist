    ...
    <div className="space-y-2">
      <div className="flex items-center gap-1.5">
        <input
          ...
          className="flex h-8 w-full rounded-md border border-input bg-background px-2.5 font-mono text-[0.75em] tabular-nums transition-colors hover:border-foreground/20 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-1 disabled:opacity-50"
        />
      ...
      <div className="flex flex-wrap gap-1">
        {PRESETS.map((p) => (
          <button
            ...
            disabled={pending}
            className={cn(
              "inline-flex h-6 items-center rounded border border-border bg-card/40 px-2 font-mono text-[0.625em] uppercase tracking-wider text-muted-foreground transition-colors hover:bg-accent hover:text-foreground disabled:cursor-not-allowed",
