      ...
      <div className="min-w-0 flex-1">
        <div className="flex items-baseline gap-2">
          ...
          <button
            ...
            className={cn(
              "block w-full break-words text-left text-[14px] leading-snug transition-colors cursor-pointer hover:text-coral",
        ...
        <div className="mt-1 flex flex-wrap items-center gap-x-3 gap-y-1 font-mono text-[11px] tabular-nums text-muted-foreground">
          {projectName && (
          ...
          {task.dueDate && (
            ...
            >
              <span className="font-mono text-[9px] uppercase tracking-[0.16em]">due</span>{" "}
