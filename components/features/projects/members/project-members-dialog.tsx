              ...
              >
                <div className="flex flex-col gap-2 sm:flex-row">
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 rounded-md bg-foreground px-3 py-1.5 font-mono text-[10px] uppercase tracking-wider text-background hover:opacity-90 disabled:opacity-50"
                  >
                  ...
                  {members.map((m) => {
                    ...
                    return (
                      <li key={m.id} className="flex items-center gap-3 px-3 py-2">
                        <span
                          aria-hidden
                          className="grid h-7 w-7 shrink-0 place-items-center rounded-full bg-foreground/10 font-mono text-[10px] uppercase text-foreground"
                        >
