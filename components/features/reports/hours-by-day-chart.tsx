            ...
            content={({ active, payload, label }) => {
              ...
              return (
                <div className="rounded-md border border-border bg-popover px-3 py-2 shadow-md">
                  <div className="font-mono text-[0.5625em] uppercase tracking-[0.14em] text-muted-foreground">
                    {String(label)}
                  </div>
                  <div className="mt-0.5 font-display text-xl leading-none tabular-nums text-foreground">
                    {v.toFixed(2)}
                    <span className="ml-1 font-mono text-[0.625em] uppercase tracking-wider text-muted-foreground">
                      h
                    </span>
                  </div>
                </div>
