      ...
      <ul className="space-y-1">
        {sorted.map((s, i) => {
          ...
          return (
            <li
              key={i}
              className="grid grid-cols-[12px_1fr_auto_64px] items-center gap-2 text-[0.75em]"
            >
              ...
              <span className="text-right font-mono text-[0.625em] uppercase tabular-nums tracking-wider text-muted-foreground">
                {pct.toFixed(1)}%
              </span>
            </li>
          );
