    ...
    <div className="mb-3 flex items-center justify-between gap-2">
      ...
      <div className="flex items-center gap-1">
        ...
        <Link
          ...
          className="inline-flex h-7 items-center rounded-md border border-border bg-card/40 px-2.5 font-mono text-[0.625em] uppercase tracking-wider text-muted-foreground transition-colors hover:bg-accent hover:text-foreground"
        >
          Today
        </Link>
        <Link
        ...
        return (
          <li key={d.toISOString()} className="text-center">
            ...
            >
              ...
              <span
                className={cn(
                  "inline-flex h-6 min-w-6 items-center justify-center rounded-full px-1 font-mono text-[0.75em] font-medium tabular-nums transition-colors",
                  isToday
