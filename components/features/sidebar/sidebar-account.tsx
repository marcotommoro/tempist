        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            ...
            >
              <span
                aria-hidden
                className="grid h-7 w-7 shrink-0 place-items-center rounded-md bg-foreground font-mono text-[10px] font-medium uppercase tracking-wider text-background"
              >
                {initials}
              </span>
          ...
          <DropdownMenuContent align="end" side="top" sideOffset={6} className="w-56">
            ...
            <div className="px-2 pb-1.5 text-[12px] text-foreground">
